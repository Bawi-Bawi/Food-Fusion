...
<div class="col-12">
    ...
    <div class="card col-md-8 mt-3">
      <div class="card-header p-2 d-flex ">
        ...
        <legend class="text-center">Add Infographic </legend>
        </div>
      <div class="card-body">
        <div class="tab-content">
            <form action="{{ route('add#infographicResources')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
            ...
            <div class="form-group row mt-3">
              ...
              <input type="hidden" name="type" value="Educational Resources">
            <div class="form-group row mt-3">
